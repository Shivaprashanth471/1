...
export interface LastNameSchemaType {
	name: string;
}

const initialValues: LastNameSchemaType = {
	name: '',
};
...
const AuthLastNameScreen = (props: any) => {
	...
	const lastNameHandler = (
		values: LastNameSchemaType,
		formikHelpers: FormikHelpers<LastNameSchemaType>,
	) => {
				...
				<BaseViewComponent noScroll={true}>
					...
					<View
						...
						<View style={styles.header}>
							<View style={{}}>
								<Text style={styles.headerText}>Tell us your last name</Text>
							</View>
...
export default AuthLastNameScreen;
